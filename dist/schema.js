...
const resolvers = {
    ...
    Mutation: {
        ...
        updateProduct: async (_, { id, name, isHazardous, sizePerUnit }, { dbClient }) => {
            let updates = [
                { name },
        ...
        deleteProduct: async (_, { id }, { dbClient }) => {
            const result = await dbClient.query(`
